<div x-data="{ open: false }" class="relative" @mouseenter="open = true" @mouseleave="open = false">
    <button @click="open = !open"
        class="relative focus:outline-none text-gray-700 dark:text-gray-300 hover:text-[#8a7f6f] transition">
        <!-- Bell Icon -->
            ...
            <div class="max-h-64 overflow-y-auto">
                @forelse(auth()->user()->unreadNotifications as $notification)
                    <div
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-sm">Mobil: {{ $notification->data['car_model'] }}
                        </p>
