...
$stepDescriptions = [
    ...
    'credit' => [
        ...
        'leasing_finalized' => 'Credit approved and down payment received. Preparing your vehicle for final inspection.',
        'processing' => 'Your vehicle is undergoing inspection.',
        'shipped' => 'Your vehicle is on its way to your address.',
...
<div class="relative w-full max-w-6xl mx-auto px-2 py-8">
    ...
    <div class="absolute top-11 left-0 right-0 h-1 bg-gray-200 dark:bg-gray-700 z-0 rounded-full overflow-hidden mx-2 md:mx-[5%]">
    ...
    <div class="relative z-10 overflow-x-auto scrollbar-hide md:overflow-visible">
        <div class="flex flex-nowrap md:flex-wrap justify-between items-start gap-y-8 gap-x-4 min-w-[520px] md:min-w-0">
            @foreach ($stepKeys as $i => $key)
                ...
                <div class="flex flex-col items-center min-w-[80px] flex-1 text-center relative group transition-all duration-300 ease-in-out">
                    <div class="relative z-10">
                        <div class="w-12 h-12 flex items-center justify-center rounded-full border-4 border-white dark:border-gray-800 shadow
