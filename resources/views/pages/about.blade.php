  ...
  <main class="flex-1">
    ...
    <section class="py-20 px-6 flex flex-wrap gap-12 items-center justify-center max-w-6xl mx-auto">
      ...
      <div class="flex-1 max-w-md" data-aos="fade-left">
        <img src="{{ asset('images/prinsip.jpg') }}" alt="Honda Building" class="rounded-xl shadow-md w-full" />
      </div>
    </section>
...
<section class="py-20 px-6 flex flex-wrap gap-12 items-center justify-center max-w-6xl mx-auto">
  ...
  <div class="flex-1 max-w-md" data-aos="fade-left">
    <img src="{{ asset('images/about-2.png') }}" alt="Honda team joining hands" class="rounded-xl shadow-md w-full" />
  </div>
</section>
