...
<div class="max-w-3xl mx-auto mt-10 px-4 sm:px-6 lg:px-8">
  ...
  <form action="{{ route('pages.dealer.brochure.update', $brochure->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-lg space-y-6">
    @csrf
    @method('PUT')
    ...
    <!-- File Upload -->
    <div>
      <label for="file" class="block text-sm font-semibold text-gray-700 mb-1">Brochure File <span class="text-gray-400">(leave blank if not changing)</span></label>
    ...
    <!-- Image Upload -->
    <div>
      <label for="image" class="block text-sm font-semibold text-gray-700 mb-1">Brochure Image <span class="text-gray-400">(leave blank if not changing)</span></label>
