    ...
    <form method="post" action="{{ route('pages.profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-4">
                ...
                <input id="logo" name="logo" type="file" class="mt-1 block w-full text-gray-700 dark:text-gray-200 file:mr-4 file:py-2 file:px-4
                    file:rounded-full file:border-0 file:text-sm file:font-semibold
                    file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100"
                    accept="image/*" />
                @if ($dealer->logo)
                    <div class="mt-2">
                        <img src="{{ asset('storage/' . $dealer->logo) }}" alt="Logo Dealer" class="h-16 rounded shadow border dark:border-gray-700" />
                    </div>
                @endif
