...
<aside class="w-64 bg-gray-50 flex flex-col">
    ...
    <nav class="mt-4">
        ...
        <!-- Link ke Dashboard -->
        <a href="{{ route('pages.dealer.dashboard') }}" class="flex items-center px-6 py-2 text-gray-700 hover:bg-gray-100">
        ...
        <a href="{{ route('pages.dealer.index') }}" class="flex items-center px-6 py-2 text-gray-700 hover:bg-gray-100 font-bold">
