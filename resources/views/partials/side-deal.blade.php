...
>
    <!-- Header: Logo & Toggle -->
    <div class="flex items-center h-16 px-2 border-b border-gray-200 dark:border-gray-700">
        ...
        <button
            ...
            class="flex items-center justify-center w-8 h-8 rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/20 focus:outline-none focus:ring-2 focus:ring-blue-500 transition ml-0"
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6  text-blue-500 dark:text-blue-400">
                    ...
                    [
                        ...
                        'icon' => '<svg class="w-6 h-6 text-blue-500 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M4 19V7m4 12V3m4 16v-7m4 7v-4m4 4v-9"/></svg>',
                    ],
                    [
                        'label' => 'Sales',
                        'route' => 'pages.dealer.order-index',
                        'icon' => '<svg class="w-6 h-6 text-blue-500 dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
[
    ...
    'icon' => '<svg class="w-6 h-6 text-blue-500 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
        <path d="M192,0 L384,110.85V332.55L192,443.4 0,332.55V110.85L192,0Z M128,206.918V357.189L170.667,381.824V231.552L128,206.918ZM42.667,157.653V307.92L85.333,332.555V182.286L42.667,157.653ZM275.991,97.759L150.413,170.595 192,194.606 317.867,121.936 275.991,97.759ZM192,49.267L66.133,121.936 107.795,145.989 233.374,73.154 192,49.267Z"/>
                   ...
                   [
    'label' => 'Orders',
    'icon' => '<svg class="w-6 h-6 text-blue-500 dark:text-blue-400" viewBox="0 0 1024 1024" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    'children' => [
        [
            'label' => 'All Orders',
            'route' => 'pages.dealer.order-index',
            'icon' => '<svg class="w-4 h-4 text-blue-500 dark:text-blue-400" viewBox="0 0 1024 1024" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M300 462.4h424.8v48H300v-48zM300 673.6H560v48H300v-48z"/>
                <path d="M818.4 981.6H205.6c-12.8 0-24.8-2.4-36.8-7.2-11.2-4.8-21.6-11.2-29.6-20-8.8-8.8-15.2-18.4-20-29.6-4.8-12-7.2-24-7.2-36.8V250.4c0-12.8 2.4-24.8 7.2-36.8 4.8-11.2 11.2-21.6 20-29.6 8.8-8.8 18.4-15.2 29.6-20 12-4.8 24-7.2 36.8-7.2h92.8v47.2H205.6c-25.6 0-47.2 20.8-47.2 47.2v637.6c0 25.6 20.8 47.2 47.2 47.2h612c25.6 0 47.2-20.8 47.2-47.2V250.4c0-25.6-20.8-47.2-47.2-47.2H725.6v-47.2h92.8c12.8 0 24.8 2.4 36.8 7.2 11.2 4.8 21.6 11.2 29.6 20 8.8 8.8 15.2 18.4 20 29.6 4.8 12 7.2 24 7.2 36.8v637.6c0 12.8-2.4 24.8-7.2 36.8-4.8 11.2-11.2 21.6-20 29.6-8.8 8.8-18.4 15.2-29.6 20-12 5.6-24 8-36.8 8z"/>
                <path d="M747.2 297.6H276.8V144c0-32.8 26.4-59.2 59.2-59.2h60.8c21.6-43.2 66.4-71.2 116-71.2 49.6 0 94.4 28 116 71.2h60.8c32.8 0 59.2 26.4 59.2 59.2l-1.6 153.6z m-423.2-47.2h376.8V144c0-6.4-5.6-12-12-12H595.2l-5.6-16c-11.2-32.8-42.4-55.2-77.6-55.2-35.2 0-66.4 22.4-77.6 55.2l-5.6 16H335.2c-6.4 0-12 5.6-12 12v106.4z"/>
            </svg>',
                            ...
                            [
                                'label' => 'Payments',
                                'route' => 'pages.dealer.order-index',
                                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 text-blue-500 dark:text-blue-400">
                            ...
                            [
                                'label' => 'Installments',
                                'route' => 'pages.dealer.order-index',
                                'icon' => '<svg class="w-4 h-4 text-blue-500 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="2"/><path stroke="currentColor" stroke-width="2" d="M12 8v4l3 3"/></svg>',
                            ],
                        ]
                    ],
                    [
                    ...
                    [
                        'label' => 'Customers',
                        'route' => 'pages.dealer.order-index',
                        'icon' => '<svg class="w-6 h-6 text-blue-500 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle cx="8" cy="8" r="4" stroke="currentColor" stroke-width="2"/><circle cx="16" cy="8" r="4" stroke="currentColor" stroke-width="2"/><path stroke="currentColor" stroke-width="2" d="M2 20c0-2.21 3.58-4 8-4s8 1.79 8 4"/><path stroke="currentColor" stroke-width="2" d="M16 16c4.42 0 8 1.79 8 4"/></svg>',
                    ],
                ]
            ]
        ];
