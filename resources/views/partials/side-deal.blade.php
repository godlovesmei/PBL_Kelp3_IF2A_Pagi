...
<aside x-data :class="$store.sidebar.open ? 'w-60' : 'w-20'"
    ...
    style="transition-property: width;" x-cloak>
    <!-- Header: Logo & Toggle -->
    <div class="flex items-center h-16 px-2 border-b border-gray-400 dark:border-gray-700">
        <!-- Logo hanya muncul saat sidebar open -->
        <div class="flex-1 flex items-center justify-center" x-show="$store.sidebar.open" x-transition.opacity>
        ...
        <button @click="$store.sidebar.open = !$store.sidebar.open"
            ...
            <svg x-show="!$store.sidebar.open" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
                viewBox="0 0 24 24" stroke="currentColor" x-cloak>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
            <svg x-show="$store.sidebar.open" xmlns="http://www.w3.org/2000/svg"
                class="w-5 h-5 transform rotate-180 transition-transform duration-300" fill="none"
                viewBox="0 0 24 24" stroke="currentColor" x-cloak>
                ...
                [
                    ...
                    'items' => [
                        ...
                        [
                            ...
                            'icon' =>
                                '<svg class="w-6 h-6 text-blue-800 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M4 19V7m4 12V3m4 16v-7m4 7v-4m4 4v-9"/></svg>',
                        ],
        ...
        <path d="M747.2 297.6H276.8V144c0-32.8 26.4-59.2 59.2-59.2h60.8c21.6-43.2 66.4-71.2 116-71.2 49.6 0 94.4 28 116 71.2h60.8c32.8 0 59.2 26.4 59.2 59.2l-1.6 153.6z m-423.2-47.2h376.8V144c0-6.4-5.6-12-12-12H595.2l-5.6-16c-11.2-32.8-42.4-55.2-77.6-55.2-35.2 0-66.4 22.4-77.6 55.2l-5.6 16H335.2c-6.4 0-12 5.6-12 12v106.4z"/>
                ...
                <path d="M747.2 297.6H276.8V144c0-32.8 26.4-59.2 59.2-59.2h60.8c21.6-43.2 66.4-71.2 116-71.2 49.6 0 94.4 28 116 71.2h60.8c32.8 0 59.2 26.4 59.2 59.2l-1.6 153.6z m-423.2-47.2h376.8V144c0-6.4-5.6-12-12-12H595.2l-5.6-16c-11.2-32.8-42.4-55.2-77.6-55.2-35.2 0-66.4 22.4-77.6 55.2l-5.6 16H335.2c-6.4 0-12 5.6-12 12v106.4z"/>
                                ...
                                [
                                    ...
                                    'icon' =>
                                        '<svg class="w-4 h-4 text-blue-800 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="2"/><path stroke="currentColor" stroke-width="2" d="M12 8v4l3 3"/></svg>',
                                ],
                            ],
                        ],
                        [
        ...
        @foreach ($menuSections as $section)
            <div>
                <div x-show="$store.sidebar.open"
                    class="pl-3 pb-1 text-xs text-gray-800 dark:text-blue-300 font-bold tracking-wider select-none uppercase">
                    {{ $section['title'] }}
                </div>
                        ...
                        <div x-data="{ open: {{ $isOpen ? 'true' : 'false' }} }">
                            <button @click="open = !open"
                                ...
                                <span x-show="$store.sidebar.open"
                                    class="ml-4 text-sm font-semibold select-none">{{ $item['label'] }}</span>
                                <svg x-show="$store.sidebar.open"
                                    class="ml-auto w-4 h-4 transform transition-transform text-blue-400"
