<header x-data="{ open: false }" @keydown.escape="open = false" class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm w-full z-30">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-2">
                <x-notification-dealer :notifications="auth()->user()?->unreadNotifications" />
    ...
    >
        <nav class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="{{ route('pages.dealer.index') }}"
                class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition"
            >
                Products
            </a>
            ...
            <a href="{{ route('pages.dealer.brochure.index') }}"
                class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition"
            >
                Brochures
            </a>
